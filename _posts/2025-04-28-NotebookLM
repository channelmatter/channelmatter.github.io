...
In a former job role, I recall the arduous (but necessary) task of performing complex pre/post architectural reviews to determine: 1) infosec viability of a new technology and then 2) infosec review of the actual implementation of that new technology. This review cycle required a lot of time from very scarce architect teams. Incurring frequent delays who CB fundamentally impacted our organization’s agility. Using NotebookLM with our own policy, we could have easily streamlined or replaced the initial review by comparing/grading new technologies with our corporate standards. 
